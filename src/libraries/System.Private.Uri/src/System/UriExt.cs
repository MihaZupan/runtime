...
namespace System
{
    public partial class Uri
    {
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                if (c == '%')
                {
                    if ((uint)(i + 2) < (uint)data.Length)
                    {
                        ...
                        if (!char.IsAscii(value) || UriHelper.UnreservedChars.Contains(value))
                        {
                            return true;
                        }
        ...
        public static string EscapeUriString(string stringToEscape) =>
            UriHelper.EscapeString(stringToEscape, checkExistingEscaped: false, UriHelper.UnreservedReservedChars);
        ...
        public static string EscapeDataString(string stringToEscape) =>
            UriHelper.EscapeString(stringToEscape, checkExistingEscaped: false, UriHelper.UnreservedChars);
        ...
        private unsafe string GetRelativeSerializationString(UriFormat format)
        {
            ...
            {
                return UriHelper.EscapeString(_string, checkExistingEscaped: true, UriHelper.UnreservedReservedChars);
            }
