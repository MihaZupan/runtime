...
namespace System.Net.Sockets
{
    public partial class SocketAsyncEventArgs : EventArgs, IDisposable
    {
        ...
        internal bool DnsConnectAsync(DnsEndPoint endPoint, SocketType socketType, ProtocolType protocolType)
        {
            ...
            // TODO: Use https://github.com/dotnet/runtime/pull/33420 once merged to make the Dns call cancelable,
            // and to also only retrieve the relevant address family addresses based on _currentSocket/_userSocket.
            ...
            Task<IPAddress[]> addressesTask = Dns.GetHostAddressesAsync(endPoint.Host /*, cancellationToken*/);
