...
namespace System.Net.Http.Tests
{
    public class HttpHeadersTest
    {
        ...
        public void TryAddWithoutValidation_AddNullValueForKnownHeader_ParserRejectsNullEmptyStringAdded()
        {
            ...
            // shouldn't be added to the list of header values. HttpHeaders will add this value to the list of invalid values.
            Assert.Equal(1, headers.Count());
            Assert.Equal(new[] { string.Empty }, headers.GetValues(headers.Descriptor));
            Assert.Equal(1, headers.Parser.TryParseValueCallCount);
        }
