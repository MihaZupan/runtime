...
namespace System.Net.Http.Headers
{
    internal static class KnownHeaders
    {
        ...
        public static readonly KnownHeader Connection = new KnownHeader("Connection", HttpHeaderType.General, GenericHeaderParser.TokenListParser, new string[] { "Keep-Alive", "close" });
