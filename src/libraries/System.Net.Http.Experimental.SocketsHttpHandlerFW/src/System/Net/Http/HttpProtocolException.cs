...
namespace System.Net.Http
{
    ...
    /// When calling <see cref="Stream"/> methods on the stream returned by <see cref="HttpContent.ReadAsStreamAsync()"/>, <see cref="HttpProtocolException"/> can be thrown directly.
    /// </remarks>
