        ...
        private sealed class Http2Stream : IValueTaskSource, IHttpStreamHeadersHandler, IHttpTrace
        {
            ...
            public Http2Stream(HttpRequestMessage request, Http2Connection connection)
            {
                ...
                else
                {
                    ...
                    if (_request.Headers.ExpectContinue == true)
                    {
                ...
                {
                    Version = HttpVersionEx.Version20,
            ...
            public async Task SendRequestBodyAsync(CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    if (sendRequestContent)
                    {
                        ...
                        Task task = _request.Content.CopyToAsync(writeStream, context: null);
                        ...
                        else
                        {
                            ...
                            // TODO - does cancellation work here?
                        ...
                        if (writeStream.BytesWritten < writeStream.ContentLength)
                        {
                            ...
                            throw new HttpRequestExceptionEx(SR.Format(SR.net_http_request_content_length_mismatch, writeStream.BytesWritten, writeStream.ContentLength));
                        }
            ...
            private static readonly int[] HpackStaticStatusCodeTable = new[] { 200, 204, 206, 304, 400, 404, 500 };
            ...
            void IHttpStreamHeadersHandler.OnStaticIndexedHeader(int index)
            {
                ...
                if (index <= LastHPackRequestPseudoHeaderId)
                {
                    ...
                    throw new HttpRequestExceptionEx(HttpRequestError.InvalidResponse, SR.net_http_invalid_response);
                }
            ...
            private void AdjustHeaderBudget(int amount)
            {
                ...
                {
                    throw new HttpRequestExceptionEx(HttpRequestError.ConfigurationLimitExceeded, SR.Format(SR.net_http_response_headers_exceeded_length, _connection._pool.Settings.MaxResponseHeadersByteLength));
                }
            }
            ...
            private void OnStatus(int statusCode)
            {
                ...
                lock (SyncObject)
                {
                    ...
                    if (_responseProtocolState == ResponseProtocolState.ExpectingHeaders)
                    {
                        ...
                        throw new HttpRequestExceptionEx(HttpRequestError.InvalidResponse, SR.net_http_invalid_response_multiple_status_codes);
                    }
                    ...
                    if (_responseProtocolState != ResponseProtocolState.ExpectingStatus)
                    {
                        ...
                        throw new HttpRequestExceptionEx(HttpRequestError.InvalidResponse, SR.net_http_invalid_response_pseudo_header_in_trailer);
                    }
            ...
            private void OnHeader(HeaderDescriptor descriptor, ReadOnlySpan<byte> value)
            {
                ...
                lock (SyncObject)
                {
                    ...
                    if (_responseProtocolState == ResponseProtocolState.ExpectingTrailingHeaders)
                    {
                        ...
                        _trailers.TryAddWithoutValidation(descriptor.Name, headerValue);
                    }
                    ...
                    else
                    {
                        ...
                        _response.Headers.TryAddWithoutValidation(descriptor.Name, headerValue);
                    }
                }
            }
            ...
            public void OnHeader(ReadOnlySpan<byte> name, ReadOnlySpan<byte> value)
            {
                ...
                else
                {
                    ...
                    {
                        // Invalid header name
                        throw new HttpRequestExceptionEx(HttpRequestError.InvalidResponse, SR.Format(SR.net_http_invalid_response_header_name, Encoding.ASCII.GetString(name)));
                    }
                ...
                lock (SyncObject)
                {
                    switch (_responseProtocolState)
                    {
                        ...
                        case ResponseProtocolState.ExpectingData:
                            ...
                            _trailers ??= new HttpResponseTrailers();
                            break;
            ...
            private void MoveTrailersToResponseMessage(HttpResponseMessage responseMessage)
            {
                if (_trailers != null)
                {
                    responseMessage.RequestMessage.Properties["__ResponseTrailers"] = _trailers;
                }
            }
            ...
            private sealed class Http2ReadStream : Http2ReadWriteStream
            {
                ...
                public override ValueTask WriteAsync(ReadOnlyMemory<byte> destination, CancellationToken cancellationToken) => ValueTaskEx.FromException(ExceptionDispatchInfo.SetCurrentStackTrace(new NotSupportedException(SR.net_http_content_readonly_stream)));
            }
            ...
            private sealed class Http2WriteStream : Http2ReadWriteStream
            {
                ...
                public override ValueTask<int> ReadAsync(Memory<byte> buffer, CancellationToken cancellationToken) => ValueTaskEx.FromException<int>(ExceptionDispatchInfo.SetCurrentStackTrace(new NotSupportedException(SR.net_http_content_writeonly_stream)));
                ...
                public override ValueTask WriteAsync(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken)
                {
                    ...
                    {
                        return ValueTaskEx.FromException(ExceptionDispatchInfo.SetCurrentStackTrace(new HttpRequestExceptionEx(SR.net_http_content_write_larger_than_content_length)));
                    }
            ...
            public class Http2ReadWriteStream : HttpBaseStream
            {
                ...
                public override ValueTask<int> ReadAsync(Memory<byte> destination, CancellationToken cancellationToken)
                {
                    ...
                    if (http2Stream == null)
                    {
                        return ValueTaskEx.FromException<int>(ExceptionDispatchInfo.SetCurrentStackTrace(new ObjectDisposedException(nameof(Http2ReadStream))));
                    }

                    if (cancellationToken.IsCancellationRequested)
                    {
                        return ValueTaskEx.FromCanceled<int>(cancellationToken);
                    }
                ...
                public override ValueTask WriteAsync(ReadOnlyMemory<byte> buffer, CancellationToken cancellationToken)
                {
                    ...
                    if (http2Stream == null)
                    {
                        return ValueTaskEx.FromException(ExceptionDispatchInfo.SetCurrentStackTrace(new ObjectDisposedException(nameof(Http2WriteStream))));
                    }
