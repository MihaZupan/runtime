...
internal static partial class Interop
{
    internal static partial class Globalization
    {
        ...
        internal static int NormalizeString(NormalizationForm normalizationForm, string src, Span<char> dstBuffer) =>
            NormalizeString(normalizationForm, src, src.Length, ref MemoryMarshal.GetReference(dstBuffer), dstBuffer.Length);
