...
{
    internal sealed class IndexOfAnyAsciiStringValuesTeddy256BucketizedN2<TStartCaseSensitivity, TCaseSensitivity> : IndexOfAnyStringValuesRabinKarp<TCaseSensitivity>
        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        public IndexOfAnyAsciiStringValuesTeddy256BucketizedN2(string[][] buckets, RabinKarp rabinKarp, HashSet<string> uniqueValues) : base(rabinKarp, uniqueValues)
        {
