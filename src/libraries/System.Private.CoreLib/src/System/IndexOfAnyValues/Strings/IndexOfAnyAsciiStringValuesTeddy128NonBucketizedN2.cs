...
namespace System.Buffers
{
        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        public IndexOfAnyAsciiStringValuesTeddy128NonBucketizedN2(ReadOnlySpan<string> values, RabinKarp rabinKarp, HashSet<string> uniqueValues) : base(rabinKarp, uniqueValues)
        {
