...
{
    internal sealed class IndexOfAnyAsciiStringValuesTeddy128BucketizedN2<TStartCaseSensitivity, TCaseSensitivity> : IndexOfAnyStringValuesRabinKarp<TCaseSensitivity>
        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        public IndexOfAnyAsciiStringValuesTeddy128BucketizedN2(string[][] buckets, RabinKarp rabinKarp, HashSet<string> uniqueValues) : base(rabinKarp, uniqueValues)
        {
