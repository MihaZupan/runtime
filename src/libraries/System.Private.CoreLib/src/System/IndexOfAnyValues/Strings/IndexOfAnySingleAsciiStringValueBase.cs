...
{
    internal class IndexOfAnySingleAsciiStringValueBase<TLongString, TStartCaseSensitivity, TCaseSensitivity> : IndexOfAnyStringValuesBase
        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        public IndexOfAnySingleAsciiStringValueBase(string value, HashSet<string> uniqueValues, int n) : base(uniqueValues)
        {
        ...
        private int IndexOfAnyN2Vector128(ReadOnlySpan<char> span)
        {
            ...
            ref char lastVectorizedSearchSpace = ref Unsafe.Add(ref searchSpace, span.Length + _lastSearchSpaceOffsetVector128);
        ...
        private int IndexOfAnyN2Avx2(ReadOnlySpan<char> span)
        {
            ...
            ref char searchSpace = ref MemoryMarshal.GetReference(span);
            ref char lastVectorizedSearchSpace = ref Unsafe.Add(ref searchSpace, span.Length + _lastSearchSpaceOffsetAvx2);
