...
namespace System.Buffers
{
    ...
    {
        public AsciiStringSearchValuesTeddyNonBucketizedN2(ReadOnlySpan<string> values, RabinKarp rabinKarp, HashSet<string> uniqueValues) : base(values, rabinKarp, uniqueValues, n: 2) { }
