...
namespace System.Buffers
{
        ...
        where TCaseSensitivity : struct, ICaseSensitivity
    {
        ...
        private readonly Vector512<byte>
            _n0Low512, _n0High512,
            _n1Low512, _n1High512,
            _n2Low512, _n2High512;
        ...
        protected AsciiStringSearchValuesTeddyBase(ReadOnlySpan<string> values, RabinKarp rabinKarp, HashSet<string> uniqueValues, int n) : base(rabinKarp, uniqueValues)
        {
            ...
            (_n0Low512, _n0High512) = (Vector512.Create(_n0Low256, _n0Low256), Vector512.Create(_n0High256, _n0High256));
            (_n1Low512, _n1High512) = (Vector512.Create(_n1Low256, _n1Low256), Vector512.Create(_n1High256, _n1High256));
            (_n2Low512, _n2High512) = (Vector512.Create(_n2Low256, _n2Low256), Vector512.Create(_n2High256, _n2High256));
        }
        ...
        private int IndexOfAnyN2Avx512(ReadOnlySpan<char> span)
        {
            ...
            Vector512<byte> n0Low = _n0Low512, n0High = _n0High512;
            Vector512<byte> n1Low = _n1Low512, n1High = _n1High512;
        ...
        private int IndexOfAnyN3Avx512(ReadOnlySpan<char> span)
        {
            ...
            Vector512<byte> n0Low = _n0Low512, n0High = _n0High512;
            Vector512<byte> n1Low = _n1Low512, n1High = _n1High512;
            Vector512<byte> n2Low = _n2Low512, n2High = _n2High512;
            Vector512<byte> prev0 = Vector512<byte>.AllBitsSet;
