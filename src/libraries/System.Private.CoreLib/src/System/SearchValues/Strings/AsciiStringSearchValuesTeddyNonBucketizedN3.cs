...
namespace System.Buffers
{
    ...
    {
        public AsciiStringSearchValuesTeddyNonBucketizedN3(ReadOnlySpan<string> values, RabinKarp rabinKarp, HashSet<string> uniqueValues) : base(values, rabinKarp, uniqueValues, n: 3) { }
