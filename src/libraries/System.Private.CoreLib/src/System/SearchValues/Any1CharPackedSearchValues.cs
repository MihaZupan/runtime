...
namespace System.Buffers
{
    internal sealed class Any1CharPackedSearchValues : SearchValues<char>
    {
        ...
        internal override bool ContainsAny(ReadOnlySpan<char> span) =>
            PackedSpanHelpers.Contains(ref MemoryMarshal.GetReference(span), _e0, span.Length);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [CompExactlyDependsOn(typeof(Sse2))]
        internal override bool ContainsAnyExcept(ReadOnlySpan<char> span) =>
            PackedSpanHelpers.ContainsAnyExcept(ref MemoryMarshal.GetReference(span), _e0, span.Length);
    }
}
