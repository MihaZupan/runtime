...
namespace System.Buffers
{
    ...
    internal unsafe struct ProbabilisticMapState
    {
        ...
        public ProbabilisticMapState(ReadOnlySpan<char> values, int maxInclusive)
        {
            ...
            PerfectHashCharLookup.Initialize(values, maxInclusive, out _multiplier, out _hashEntries);
        }
        ...
        public bool FastContains(char value)
        {
            ...
            return PerfectHashCharLookup.Contains(_hashEntries, _multiplier, value);
        }
            ...
            where TNegator : struct, IndexOfAnyAsciiSearcher.INegator
        {
            ...
            if (TUseFastContains.Value)
            {
                ...
                {
                    char c = cur;
                    if (TNegator.NegateIfNeeded(PerfectHashCharLookup.Contains(hashEntries, multiplier, c)))
                    {
