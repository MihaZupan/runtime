...
namespace System.Buffers
{
    internal static class IndexOfAnyAsciiSearcher
    {
        ...
        {
            public Vector512<byte> Bitmap512 = DuplicateTo512(bitmap);
        ...
        {
            public Vector512<byte> Bitmap0_512 = DuplicateTo512(bitmap0);
            public Vector512<byte> Bitmap1_512 = DuplicateTo512(bitmap1);
            public BitVector256 Lookup = lookup;
            ...
            where TNegator : struct, INegator
        {
            ...
            if (IsVectorizationSupported)
            {
                ...
                if (TryComputeBitmap(asciiValues, (byte*)&state.Bitmap512, out bool needleContainsZero))
                {
