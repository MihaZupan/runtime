...
namespace System.Buffers.Text
{
    public sealed class IndexOfAnyAsciiSearcher
    {
        ...
        public bool Contains(char c) => c < 128 && _lookup.Contains(c);

        public bool Contains(byte b) => _lookup.Contains(b);

        public int IndexOfAny(ReadOnlySpan<char> searchSpace) => IndexOfAny<DontNegate>(searchSpace);

        public int IndexOfAnyExcept(ReadOnlySpan<char> searchSpace) => IndexOfAny<Negate>(searchSpace);

        public int LastIndexOfAny(ReadOnlySpan<char> searchSpace) => LastIndexOfAny<DontNegate>(searchSpace);

        public int LastIndexOfAnyExcept(ReadOnlySpan<char> searchSpace) => LastIndexOfAny<Negate>(searchSpace);

        public int IndexOfAny(ReadOnlySpan<byte> searchSpace) => IndexOfAny<DontNegate>(searchSpace);

        public int IndexOfAnyExcept(ReadOnlySpan<byte> searchSpace) => IndexOfAny<Negate>(searchSpace);

        public int LastIndexOfAny(ReadOnlySpan<byte> searchSpace) => LastIndexOfAny<DontNegate>(searchSpace);

        public int LastIndexOfAnyExcept(ReadOnlySpan<byte> searchSpace) => LastIndexOfAny<Negate>(searchSpace);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool TryIndexOfAny(ref char searchSpace, int searchSpaceLength, ReadOnlySpan<char> asciiValues, out int index) =>
            TryIndexOfAny<DontNegate>(ref Unsafe.As<char, short>(ref searchSpace), searchSpaceLength, asciiValues, out index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool TryIndexOfAnyExcept(ref char searchSpace, int searchSpaceLength, ReadOnlySpan<char> asciiValues, out int index) =>
            TryIndexOfAny<Negate>(ref Unsafe.As<char, short>(ref searchSpace), searchSpaceLength, asciiValues, out index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool TryLastIndexOfAny(ref char searchSpace, int searchSpaceLength, ReadOnlySpan<char> asciiValues, out int index) =>
            TryLastIndexOfAny<DontNegate>(ref Unsafe.As<char, short>(ref searchSpace), searchSpaceLength, asciiValues, out index);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool TryLastIndexOfAnyExcept(ref char searchSpace, int searchSpaceLength, ReadOnlySpan<char> asciiValues, out int index) =>
